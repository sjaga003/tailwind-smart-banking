    ...
    <footer className="bg-primary-0 text-white flex flex-col items-center py-10">
      ...
      <div>
        <div className="flex flex-col items-center">
          <span className="my-4 cursor-pointer hover:text-green-500">
            About Us
          </span>
          <span className="mb-4 cursor-pointer hover:text-green-500">
            Contact
          </span>
          <span className="mb-4 cursor-pointer hover:text-green-500">Blog</span>
        </div>
        <div className="flex flex-col items-center">
          <span className="mb-4 cursor-pointer hover:text-green-500">
            Careers
      ...
      <div className="flex flex-col items-center">
        <button className="text-bold mt-3 rounded-full bg-gradient-to-r from-green-500 to-blue-500 px-4 py-2 text-white w-36 mb-4 hover:from-green-400 hover:to-blue-400">
          Request Invite
        </button>
