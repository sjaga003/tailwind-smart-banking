    ...
    <footer className="bg-primary-0 text-white flex flex-col items-center py-20 md:flex-row md:px-10 md:justify-between ">
      ...
      <div className="md:flex-row md:flex">
        <div className="flex flex-col items-center md:items-start ">
          <span className="my-4 cursor-pointer hover:text-green-500 md:m-2 md:mt-0">
            About Us
          </span>
          <span className="mb-4 cursor-pointer hover:text-green-500 md:m-2">
            Contact
          </span>
          <span className="mb-4 cursor-pointer hover:text-green-500 md:m-2">
            Blog
        ...
        <div className="flex flex-col items-center md:items-start md:ml-14">
          <span className="mb-4 cursor-pointer hover:text-green-500 md:m-2 md:mt-0">
            Careers
          </span>
          <span className="mb-4 cursor-pointer hover:text-green-500 md:m-2">
            Support
